...
$PM_{mode}$ & Part modale du mode en indice. L'indice peut être AC (autoconducteur), AP (autopassager), TC (Transport en commun), MV (Marche Vélo) et BS (Bus scolaire) au fins de cette étude \\
