...
\begin{tikzpicture}
                ...
                \node (converted_values) [io,above of=start,yshift=0.5cm]{PCI = Intrants convertis };
                ...
                \node (selection_seuil) [process,below of=unique_unit,yshift=-.6cm,text width=2cm]{Sel. proch. seuil et PCI };
                ...
                \node (se_data_def) [below of=oper_inter_def,yshift=0.45cm]{$SE_{data}$: définition du sous-ensemble};
