...
\begin{tikzpicture}
                ...
                \node (calc_min) [process,below  of=selection_seuil,yshift=-.6cm,text width=2.25cm]{$n_{places} = a \times in +b$};
                ...
                \node (calc_min_sum) [process,anchor=base,text width=2.25cm,yshift=1.75cm] at (select_next_unit |-calc_min.east) {$n_{places} = a \times in +b$};
