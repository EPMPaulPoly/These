\section{Méthode d'inventaire hors rue basée sur les codes d'urbanisme}\label{sec:meth_urb_based_inventory}
   ...
   \end{table}\par
    ...
    \subsection{Structure de données représentant les règlements} \label{ssec:survol-repres-reglements}
        ...
        Les graphiques suivants donnent quelques statistiques descriptives sur les règlements sauvegardés. Il est important de noter que les règlements n'ont été recensés que jusqu'au milieu des années '90. Les plus vieux règlements recensés ont été répliqués pour être utilisées pour les plus vieilles juridictions. Ceci implique que même les propriétés construites avant l'avènement de l'automobile sont modélisées comme ayant du stationnement. Cette approche peut sembler contre-intuitive puisque ces règlements n'existaient pas auparavant mais beaucoup de vieilles propriétés ont vu des stationnement aménagés après construction. Aucune analyse de sensibilité n'a été complétée pour voir quel effet cela aurait sur l'offre de stationnement prédite, particulièrement dans les quartiers centraux.\par
        La figure \ref{fig:nombre-reg-date} montre la distribution des règlements par ville, texte de loi, année d'entrée en vigueur et d'abrogation et ville. On constate que les règlements post harmonisation dominent les comptes. Ceci est du au fait que ces règlements étaient facilement disponibles et constitue un important biais de l'étude.  
        \begin{figure}[h]
            \centering
        ...
        \end{figure}
        Tel que mentionné plus haut, des réglements qui sont des duplications des règlements les plus vieux sondés ont été créés
        \FloatBarrier
    ...
    \subsection{Structure de données représentant l'ensemble des règlements applicables sur un territoire à une période donnée} \label{ssec:ensembles_association}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.9\linewidth]{figures/distro-data-role-manquant.pdf}
