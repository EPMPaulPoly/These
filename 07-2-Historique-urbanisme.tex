...
Cette section portera sur la solution proposée pour répondre aux objectifs mis de l'avant en \ref{sec:obj_recherche}. Les sections \ref{sec:geopolitique_quebec} et \ref{sec:politiques_stationnement} donneront un aperçu de la géopolitique de la ville de Québec depuis la Deuxième Guerre mondiale et les modalités des codes d'urbanisme depuis 1995. La section \ref{sec:meth_donnees_dispo} présente les données disponibles pour créer l'inventaire. La section \ref{sec:meth_urb_based_inventory} présente la méthodologie utilisée pour calculer l'inventaire basé sur les codes d'urbanisme. La section \ref{sec:meth_valid} discutera de la méthode utilisée pour évaluer la méthode d'inventaire. La section \ref{sec:meth_tool} discutera de l'architecture de l'outil web développé dans le cadre du mémoire et la section \ref{sec:meth_analyse} discutera des indicateurs utilisés pour l'analyse.
\section{Géopolitique de la ville de Québec}\label{sec:geopolitique_quebec}
Cette section va faire un historique de la géopolitique de la ville de Québec. Ce travail dégage de grandes époques où les frontières sont restées stables. On observe trois grandes raflées de fusions \parencite{ville_de_quebec_reperes_nodate}:
\begin{itemize}
  \item '65-'72:
  ...
  \item 2002: Fusions aux limites actuelles incluant  St-Augustin et L'Ancienne-Lorette
  \item 2006: Séparation St-Augustin de Desmaures et L'Ancienne-Lorette
\end{itemize}
\FloatBarrier
La figure \ref{fig:municipalites_carto_historique} montre l'évolution des municipalités, et la figure \ref{fig:types_unites_voisinage} montre les zones issues des codes d'urbanismes avec des réglements différents. 
\begin{figure}[ht]
  \centering
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{Secteurs ayant des minimum de stationnement différents \parencite{ville_de_quebec_grille_2024,ville_de_quebec_zonage_2024,ville_de_quebec_reglement_1995}}
