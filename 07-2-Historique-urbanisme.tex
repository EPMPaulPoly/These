...
Cette section portera sur la solution proposée pour répondre aux objectifs mis de l'avant en \ref{sec:obj_recherche}. Les sections \ref{sec:geopolitique_quebec} et \ref{sec:politiques_stationnement} donneront un aperçu de la géopolitique de la ville de Québec depuis la Deuxième Guerre mondiale et les modalités des codes d'urbanisme depuis 1995. La section \ref{sec:meth_donnees_dispo} présente les données disponibles pour créer l'estimation de la capacité. La section \ref{sec:meth_urb_based_inventory} présente la méthodologie utilisée pour calculer l'estimation basée sur les codes d'urbanisme. La section \ref{sec:meth_valid} discutera de la méthode utilisée pour évaluer le modèle de prédiction. La section \ref{sec:meth_tool} discutera de l'architecture de l'outil web développé dans le cadre du mémoire et la section \ref{sec:meth_analyse} discutera des indicateurs utilisés pour l'analyse.
\section{Géopolitique de la ville de Québec}\label{sec:geopolitique_quebec}
Cette section va faire un historique de la géopolitique de la ville de Québec. Ce travail dégage de grandes époques où les frontières sont restées stables. On observe trois grandes séries de fusions \parencite{ville_de_quebec_reperes_nodate}:
\begin{itemize}
  \item '65 - '72:
  ...
  \item 2002: Fusions aux limites actuelles incluant  Saint-Augustin et L'Ancienne-Lorette
  \item 2006: Séparation St-Augustin de Desmaures et L'Ancienne-Lorette
\end{itemize}
\FloatBarrier
La figure \ref{fig:municipalites_carto_historique} montre l'évolution des municipalités, et la figure \ref{fig:types_unites_voisinage} montre les zones issues des codes d'urbanisme avec des règlements différents. 
\begin{figure}[ht]
  \centering
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[t]{0.5\textwidth}
    ...
    \caption{1995-1996}\label{fig:zonage-1995-1997}
  \end{subfigure}~
  \begin{subfigure}[t]{0.5\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{images/geographie_code_urbanisme_1997-2009.png}
    \caption{1997-2009}\label{fig:zonage-1997-2009}
  \end{subfigure}\\
  \begin{subfigure}[t]{0.6\textwidth}
  \centering
  \includegraphics[width=0.8\linewidth]{images/geographie_code_urbanisme_2009_present.png}
  \caption{2010-présent}\label{fig:zonage-2009-pres}
  \end{subfigure}
  \caption{Secteurs ayant des minimums de stationnement différents \parencite{ville_de_quebec_grille_2024,ville_de_quebec_zonage_2024,ville_de_quebec_reglement_1995}}
...
La ville de Québec vient d'abroger ses requis pour l'habitation pour les zones en milieu dense ou le long des axes de transport en commun \parencite{ville_de_quebec_rvq_2024}.\par
  En plus de l'hétérogénéité spatiale qui est décrite à la section \ref{sec:geopolitique_quebec}, on constate aussi une hétérogénéité au niveau des catégories utilisées pour les requis de stationnement. Ceci est d'autant plus ardu que les catégories utilisées dans les minimums de stationnement n'ont pas nécessairement d'équivalents directs dans le \ac{CUBF} utilisé dans le rôle foncier du Québec \parencite[Annexe 2C.1]{gouvernement_du_quebec_manuel_2024}. Le tableau \ref{tab:req_stat_presents} et la figure \ref{fig:n_utilisation_CUBF_minimums} résument la présence d'un requis de stationnement explicité ou inféré pour un code \ac{CUBF} donné \parencite{ville_de_quebec_rvq_2024,ville_de_quebec_reglement_1995}. Les codes d'urbanisme des municipalités avant harmonisation sont issus d'un résumé fourni par la ville\parencite{ville_de_quebec_residentiel_2008,ville_de_quebec_commercial_2008}. Cette synthèse est nécessairement sujette à interprétation: les catégories dans le code d'urbanisme ne sont pas constantes entre les codes avec différents niveaux de superposition ou catégorisation par municipalité, rendant une synthèse difficile. La synthèse est recalée sur les codes \ac{CUBF} pour la simple raison que cette donnée sera exploitée pour choisir la réglementation à appliquer pour inférer une capacité de stationnement requise. Les données post-fusion sont issues de l'historique des règlements disponibles en ligne pour la ville de Québec \parencite{ville_de_quebec_reglement_1995,ville_de_quebec_rvq_2009}. Les altérations du code \parencite{ville_de_quebec_rvq_2016,ville_de_quebec_rvq_2017,ville_de_quebec_rvq_2018,ville_de_quebec_rvq_2018-1,ville_de_quebec_rvq_2019,ville_de_quebec_rvq_2022,ville_de_quebec_rvq_2023,ville_de_quebec_rvq_2023-1,ville_de_quebec_rvq_2024} depuis l'harmonisation en 2009 ont toutes été modélisées.
  %\tiny
  ...
  \begin{landscape}
    \begin{center}
      \begin{longtable}{P{1.0cm} | p{7.5cm} | c || *{12}{P{5mm}}||p{6mm}} 
        \caption{Présence de réglementation de stationnement selon le code \ac{CUBF}}\label{tab:req_stat_presents}\\
        ...
        \hline  
        \endfirsthead
        \multicolumn{16}{c}{\textsc{Tableau}~\ref{tab:req_stat_presents} (Suite)}\\
        \multirow{2}{*}{\STAB{\rotatebox[origin=c]{90}{Categ}}} & Juridiction & \STAB{\rotatebox[origin=c]{90}{Code \ac {CUBF}}} & \rotatebox[origin=c]{90}{  VDQ (2009-présent)} & \rotatebox[origin=c]{90}{VDQ (1995-2009)} & \rotatebox[origin=c]{90}{Beauport} & \rotatebox[origin=c]{90}{Cap-Rouge} & \rotatebox[origin=c]{90}{Charlesbourg} & \rotatebox[origin=c]{90}{Lac St-Charles} & \rotatebox[origin=c]{90}{Loretteville} & \rotatebox[origin=c]{90}{Sillery} & \rotatebox[origin=c]{90}{Ste-Foy} & \rotatebox[origin=c]{90}{St-Émile} & \rotatebox[origin=c]{90}{Val-Belair} & \rotatebox[origin=c]{90}{Vanier} & \rotatebox[origin=c]{90}{Nombre de requis} \\
        %& No. Règl. & MEFQ & R.V.Q. 1400 & V.Q.Z. 3 & 87-806 & 1151-95 & 96-2921 & 88-257 & 1386 & 950 & 3501 & 310-89 & VB-344-88 & 93-05-1245\\
        \hline  
        \endhead
        ...
        \multirow{2}{*}{\STAB{\rotatebox[origin=c]{60}{Hôtels}}} & Hôtel & 5831&\OCHECK{}&\YCHECK&\YCHECK&\OCHECK{}&\OCHECK{}&\OCHECK{}&\OCHECK{}&\OCHECK{}&\OCHECK{}&\OCHECK{}&\OCHECK{}&\OCHECK{}&2\\
        ...
        \multirow{15}{*}{\STAB{\rotatebox[origin=c]{90}{Services}}}& Finance, Assurance et Service immobilier & 61XX&\OCHECK{}&\YCHECK&\OCHECK{}&\OCHECK{}&\OCHECK{}&\OCHECK{}&\YCHECK&\OCHECK{}&\OCHECK{}&\YCHECK&\OCHECK{}&\YCHECK&4\\
        ...
        \multirow{15}{*}{\STAB{\rotatebox[origin=c]{90}{Services}}}& Service médical et de santé & 651X&\YCHECK&\YCHECK&\OCHECK{}&\OCHECK{}&\YCHECK&\YCHECK&\YCHECK&\YCHECK &\YCHECK & \OCHECK{} &\YCHECK & \OCHECK{}&9\\
        ...
        \hline
        \multirow{3}{*}{\STAB{\rotatebox[origin=c]{90}{Culture}}} & Culture, Récréation et loisirs&7XXX &\NCHECK&\YCHECK&\YCHECK&\NCHECK&\YCHECK&\YCHECK&\NCHECK&\YCHECK&\NCHECK&\YCHECK&\YCHECK&\YCHECK&8\\
        ...
        \multirow{8}{*}{\STAB{\rotatebox[origin=c]{90}{Récréation}}} & Installation sportive (Stade, Hippodrome)&722X&\YCHECK&\OCHECK{}&\OCHECK{}&\NCHECK&\OCHECK{}&\OCHECK{}&\YCHECK&\OCHECK{}&\YCHECK&\OCHECK{}&\OCHECK{}&\OCHECK{}&3\\
        & Centre de congrès & 723X & \OCHECK{} & \YCHECK & \OCHECK{} & \NCHECK & \OCHECK{} & \OCHECK{}& \YCHECK& \OCHECK{} & \OCHECK{} & \OCHECK{} & \OCHECK{} & \OCHECK{}&2 \\
        & Activités récréative s&74XX&\YCHECK&\OCHECK{}&\YCHECK&\NCHECK&\OCHECK{}&\OCHECK{}&\YCHECK&\OCHECK{}&\YCHECK&\OCHECK{}&\OCHECK{}&\OCHECK{} &4\\
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=15cm]{figures/distribution_reglement_top.pdf}
      \caption{Utilisations du sol les plus récurrentes dans les règlements recensés}\label{fig:n_utilisation_CUBF_minimums}
    \end{figure}
  \end{landscape}
  %\normalsize
  \FloatBarrier
  
  Les objets sur lesquels sont basés les codes d'urbanisme sont aussi hétérogènes. Bien que la plupart des requis soient  basés sur une surface de plancher, certains sont exprimés en fonction d'autres objets considérés pertinents. D'autre part, deux municipalités n'utiliseront pas nécessairement la même unité pour formuler leur règlement. Le tableau \ref{tab:objet_pour_inference_capacite} synthétise les objets considérés et les usages pour lesquels ils sont utilisés.

\begin{table}[h]
    
    \caption{Récapitulatif des objets considérés pour fixer les capacités de stationnement}\label{tab:objet_pour_inference_capacite}
    \centering
    \begin{tabular}{p{4cm} p{10cm}}
      \hline
      Objets considérés & Usages pertinents \\
      \hline
      ...
      Employé & Services et vente au détail et industries\\
