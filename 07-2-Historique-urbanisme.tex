...
\end{itemize}
\FloatBarrier
La figure \ref{fig:municipalites_carto_historique} montre l'évolution des municipalités, et la figure \ref{fig:types_unites_voisinage} montre les zones issues des codes d'urbanismes avec des règlements différents. 
\begin{figure}[ht]
  \centering
