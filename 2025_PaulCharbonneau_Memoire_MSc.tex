...
\usepackage{amsmath,color,soulutf8,longtable,colortbl,setspace,xspace,url,pdflscape,amsthm,multirow,rotating,neuralnetwork,tikz,makecell}
...
\include{6-1-Revue-stat-mobilite}
\include{6-2-Revue-stat-inventaire}
\include{6-3-Revue-AM}
\include{7-1-Details_Solution}             %  "Détails de la Solution" (Maîtrise)
\include{7-2-Resultats_Solution}          %  "Résultats théoriques et expérimentaux" (Maîtrise)
