...
La motorisation a été estimée ainsi que les profils d'accumulation véhicule à partir des données de l'enquête OD. Elle est montrée à la figure \ref{fig:motorisation-par-quartier} à titre indicatif
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{images/motorisation-par-quartier.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.66\linewidth]{images/stat-res-par-log.png}
