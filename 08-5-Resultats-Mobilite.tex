...
\end{figure}
Plusieurs facteurs contribuent à ce résultat. Tout d'abord, l'utilisation du sol varie selon les quartiers. D'autre part, la métrique donne une mesure brute sans compenser pour le stationnement souterrain ou en structure étagée. Finalement, l'absence de compensation pour pour les données absentes rend les constats difficiles à interpréter.\par
