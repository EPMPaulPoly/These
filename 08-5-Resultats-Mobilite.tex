...
\end{figure}
Les prédictions peuvent aussi être utilisées pour estimer le pourcentage du territoire dédié au stationnement. Les quartiers voient une part plus grande de leur territoire dédié au stationnement. 
\begin{figure}[H]
    \centering
    \begin{subfigure}{1\textwidth}
        \centering
...
\end{figure}
Plusieurs facteurs contribuent à ce résultat, l'utilisation du sol variant selon les secteurs, l'absence de compensation pour le fait qu'une partie du stationnement est souterraine ou en étages dans les quartiers centraux et la variation du taux de données absentes selon l'utilisation du sol et le quartier.\par
