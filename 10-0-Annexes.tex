...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{images/geopol-per-1}
    \caption{Découpage pour la période 1}\label{fig:ann-dec-per-1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{images/geopol-per-3}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{images/geopol-per-5}
    \caption{Découpage pour la période 5}\label{fig:ann-dec-per-5}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{images/geopol-per-6}
    \caption{Découpage pour la période 6}\label{fig:ann-dec-per-6}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{images/geopol-per-7}
