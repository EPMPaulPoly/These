...
\section{Sélection d'entrées du rôle foncier lors d'un calcul par quartier d'analyse}\label{sec:annex-select-tax-data}
...
\section{Assignation des ensembles de règlements aux entrées du rôle à l'intérieur du quartier}\label{sec:annex-assign-rule-to-role}
...
\end{lstlisting}
\section{Assignation des données foncières aux RST}
