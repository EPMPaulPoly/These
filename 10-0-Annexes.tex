...
\begin{itemize}
    ...
    \item GET /api/valid/graphiques: obtient les graphiques pour la page de validation. L'identifiant de strate, le type de graphique et la valeur max de x peuvent être spécifiés comme paramètres de requête. Le retour de la foncition est dans un format compatible avec react charts.
...
Le code suivant donne la fonction utiliser pour choisir entre l'inventaire de deux sous-ensembles:
