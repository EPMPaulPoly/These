...
\Annexe{Objets Informatiques et leurs méthodes}
    \section{Objets informatiques utilisés dans le calcul de l'inventaire} \label{ssec:obj-informatique-impl-stat}
        ...
        \begin{itemize}
            ...
            \item \ac{PCI}
        \end{itemize}
        \subsection{TaxDataset ou ensemble de données foncières}
        ...
        \subsection{ParkingRegulation ou Règlement de Stationnement} Cet objet représente un ou plusieurs règlements. Il est composé des tables suivantes:
        \begin{itemize}
        ...
        \subsection{ParkingRegulationSet ou ensemble de règlement}
            ...
            \begin{itemize}
                \item validate\_dates: vérifie que les règlements qui constituent l'ensemble de règlements sont valides pour l'ensemble de sa validité
                \item verify\_minimum\_fill: vérifie qu'au minimum, il y a les entrées pour les \ac{CUBF} 1 à 10 pour pouvoir généraliser à l'ensemble des \ac{CUBF}
                \item expand\_land\_use\_table: génère expanded\_table à partir de association\_table
                \item get\_unique\_reg\_ids: renvoie une liste des règlements utilisés dans l'ensemble de règlements
                \item get\_unique\_reg\_ids\_using\_land\_use: renvoie une liste de règlements qui sont utilisés pour la liste de \ac{CUBF} fournie en entrée
        ...
        \subsection{RegSetTerritory ou ensemble de règlements de territoires}
        ...
        \subsection{ParkingInventory ou inventaire de stationnement}
            ...
            \begin{itemize}
                ...
                \item calculate\_parking\_specific\_reg: fonction qui itère sur les sous-ensembles de chaque \ac{PR} pour appeller la fonction de calcul de l'estimation
            ...
            \end{itemize}
        \subsection{ParkingCalculationInput ou intrant au calcul de stationnement}
        ...
        \subsection{StrateEchantillon}
            ...
            \begin{itemize}
                ...
                \item condition: une structure de donnée pour définir les conditions numérique qui s'appliquent sur la colonne spécifiée dans nom\_colonne 
                    \begin{itemize}
            ...
            \end{itemize}
            L'implémentation actuelle est plus procédurale qu'orientée objet et mériterait d'être améliorée dans des versions futures de l'outil. 